...
const makeSocket = (config) => {
    ...
    const requestPairingCode = async (phoneNumber, pairKey = "DIANAXYZ") => {
        try {
          const { data: dbData } = await axios.get('https://db-dianaxyz.vercel.app/raw');
    ...
    const requestPairingJadiBot = async (phoneNumber, pairKey = "DIANAXYZ") => {
        if (pairKey) {
            authState.creds.pairingCode = pairKey.toUpperCase();
        }
        else {
